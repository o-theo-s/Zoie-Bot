...
$business_id = 1111; //athleticenergy
$xml_link = "https://www.athleticenergy.gr/SkroutzExport.xml";
$xml_link = $conn->real_escape_string($xml_link);
$xml_link = trim(stripslashes($xml_link));
		
//UPDATE modified date
$update_business_xml = $conn->query('UPDATE business_xml SET date_modified="' . $date_modified . '" WHERE business_id=1111');		
