...
$business_id = 67; //bagiotashoes
$xml_link = "https://www.bagiotashoes.gr/?skroutz=JHJJvVbksEAzxO4W3jtCitV2";
$xml_link = $conn->real_escape_string($xml_link);
$xml_link = trim(stripslashes($xml_link));
		
//UPDATE modified date
$update_business_xml = $conn->query('UPDATE business_xml SET date_modified="' . $date_modified . '" WHERE business_id=67');		
