...
$business_id = 115; //shopnroll
$xml_link = "https://www.shopnroll.gr/xml-feed/skroutz.gr.php";
$xml_link = $conn->real_escape_string($xml_link);
$xml_link = trim(stripslashes($xml_link));
		
//UPDATE modified date
$update_business_xml = $conn->query('UPDATE business_xml SET date_modified="' . $date_modified . '" WHERE business_id=115');		
